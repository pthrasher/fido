...
#include <stdio.h>     // Needed for print functions, outputting data.
#include <errno.h>     // Needed for access to global `errno`

#include "bit-array.h" // Needed for all bit-array related stuff.

void server_init(int *hostSocket, struct sockaddr_in *hostAddr, int port) {
